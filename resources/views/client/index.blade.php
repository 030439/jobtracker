              ...
              <div class="row">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="row separate-row">
                        <div class="col-sm-6">
                          <div
                            class="job-icon pb-4 d-flex justify-content-between"
                          >
                            <div>
                        ...
                        <div class="col-sm-6">
                          <div
                            class="job-icon pt-4 d-flex justify-content-between"
                          >
                            <div>
                              <div class="d-flex align-items-center mb-1">
                ...
                <div class="col-xl-12">
                  <div class="card" id="user-activity1">
                    ...
                    <div class="card-body">
                      ...
                      <span class="fs-16 font-w600 me-5"
                        >239
                        <small class="text-success fs-12 font-w400"
                          >+0.4%</small
                        ></span
                      >
                ...
                <div class="col-xl-12">
                  <div class="card">
                    ...
                    <div
                      class="card-body pt-3 loadmore-content dlab-scroll height370"
                      id="scroll-y"
                    >
              ...
              <div class="row">
                          ...
                          <div class="update-profile d-flex">
                            ...
                            <div class="ms-4">
                              ...
                              <span
                                ...
                                >Medan, Sumatera Utara - ID</span
                              >
                            </div>
                          </div>
                        </div>
                        <div
                          class="col-xl-4 col-xxl-5 col-sm-5 sm-mt-auto mt-3"
                        >
                          <a
                            href="javascript:void(0);"
                      ...
                      <div class="row mt-4 align-items-center">
                        ...
                        <div class="col-xl-6 col-sm-6">
                          <div class="progress default-progress">
                            <div
                              class="progress-bar bg-green progress-animated"
                          ...
                          >
                            ...
                            <span class="fs-16"
                              ><span class="text-black pe-2"></span>90%</span
                            >
                          </div>
                          <div class="progress default-progress">
                            <div
                          ...
                          >
                            ...
                            <span class="fs-16"
                              ><span class="text-black pe-2"></span>68%</span
                            >
                          </div>
                          <div class="progress default-progress">
                            <div
                              class="progress-bar bg-blue progress-animated"
                          ...
                          >
                            ...
                            <span class="fs-16"
                              ><span class="text-black pe-2"></span>85%</span
                            >
                          </div>
                        </div>
                        <div class="col-xl-6 col-sm-6">
                ...
                <div class="col-xl-12">
                  <div class="card">
                    ...
                    <div
                      class="card-body loadmore-content dlab-scroll height370 recent-activity-wrapper"
                ...
                <div class="col-xl-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div
                        class="owl-carousel owl-carousel owl-loaded front-view-slider"
                      >
                        <div class="items">
                          <div class="jobs">
