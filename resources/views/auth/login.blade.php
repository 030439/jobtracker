...
<!-- Mirrored from jobick.dexignlab.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Mar 2023 14:45:42 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form action="https://jobick.dexignlab.com/xhtml/index.html" method="POST" action="{{ route('login') }}">
                                        <div class="mb-3">
